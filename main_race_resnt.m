...
%Import Data
 imdsTrain = imageDatastore("D:\AGE & GENDER IDENTIFICATION\face-age-gender_20190901\face-age-gender\UTK_DUPPPPPPPPP\UTK_Race","IncludeSubfolders",true,"LabelSource","foldernames");
 [imdsTrain, imdsValidation] = splitEachLabel(imdsTrain,0.8,"randomized");
 save('imds_race.mat','imdsTrain','imdsValidation');
